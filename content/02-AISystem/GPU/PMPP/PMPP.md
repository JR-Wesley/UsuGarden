...
> 《Programming Massively Parallel Processors》学习：基础概念、并行模式与高级实践。
...
- [[02-AISystem/GPU/PMPP/一-基础|一-基础]]：基础总览
- [[02-AISystem/GPU/PMPP/课程整理|课程整理]]：课程笔记

> 注：自动区块中 `3-Advanced-Patterns-and-Applications`（目录可能为空/待整理）未列入主题地图。
