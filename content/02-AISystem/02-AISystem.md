...
| [[Acceleration/Acceleration\|Inference]] | 推理：Attention/kv-cache、量化、推理加速方法论、解码 | 进行中 |
...
3. [[Acceleration/Acceleration|Inference]] → [[02-AISystem/AI-compiler/AI-compiler|AICompiler]] 覆盖推理与编译优化
