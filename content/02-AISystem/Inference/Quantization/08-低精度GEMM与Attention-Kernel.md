...
通用 GEMM 分块、MMA fragment 与 CUDA pipeline 的基础连接到 [[02-AISystem/GPU/tensor-core/CuTe/cutlass与GEMM|CUTLASS 与 GEMM]] 和 [[02-AISystem/GPU/tensor-core/MMA|MMA]]。本篇只解释低精度表示给这些结构增加了哪些数据路径和约束。
