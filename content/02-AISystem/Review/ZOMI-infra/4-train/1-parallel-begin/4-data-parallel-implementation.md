...
接下来我们来看 Pytorch2.0 [[../../AI-sys/1]](https://github.com/Infrasys-AI/AIInfra/blob/main/04Train/01ParallelBegin/04.data_parallel_implement.md#ref1) 中分布式数据并行具体的实现方式，这里我们先不涉及 Pytorch2.0 或 torchdynamo 引入的编译部分，**分布式系统的编译优化**将在一个单独的章节中进行介绍。首先我们看看 DDP 的**初始化**与**前向传播**，以及在这个过程中是如何**维护模型一致性**的。
...
[04.data-parallel-implement01](assets/4-data-parallel-implementation.assets/04.data-parallel-implement01.png)
