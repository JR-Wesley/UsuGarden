# 存储与通信（2-Store-Communication）

> 存储与通信专题：RDMA 入门、Scale-up/out 扩展，集合通信与通信库深入。
...
- [[RDMA-intro]]：RDMA 入门
- [[scaleup-and-out]]：Scale-up/out

> 注：自动区块中 `AISysReview/ZOMI infra/.../3_Store` 为旧路径失效链接，未收入人工 MOC。
