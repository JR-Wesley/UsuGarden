...
[02MOE-history-03](assets/2-MoE-history.assets/02MOE-history-03.png)
...
[02MOE-history-04](assets/2-MoE-history.assets/02MOE-history-04.png)

稠密 MoE 的核心特征为**全专家激活**，对每个输入 token，门控网络生成所有专家的权重 G ( x ) ∈ R N。优势是保留所有专家信息，无需处理负载均衡问题，适合需要细粒度融合的任务（如多模态），但劣势是计算成本随专家数量线性增长 O ( N )，难以扩展。稠密混合专家 MoE 模型广泛用在 EvoMoE、MoLE、LoRAMoE 和 DS-MoE 等研究。
...
[02MOE-history-05](assets/2-MoE-history.assets/02MOE-history-05.png)
...
[02MOE-history-06](assets/2-MoE-history.assets/02MOE-history-06.png)
...
[02MOE-history-07](assets/2-MoE-history.assets/02MOE-history-07.png)
...
- N：专家总数
- μ：容量因子 (通常 1.0-1.25)
[02MOE-history-08](assets/2-MoE-history.assets/02MOE-history-08.png)
...
[02MOE-history-09](assets/2-MoE-history.assets/02MOE-history-09.png)
...
[02MOE-history-10](assets/2-MoE-history.assets/02MOE-history-10.png)
...
[02MOE-history-11](assets/2-MoE-history.assets/02MOE-history-11.png)
...
[02MOE-history-12](assets/2-MoE-history.assets/02MOE-history-12.png)

如上图所示，其有 8 个独立的专家网络。每个专家中包含 32 个 Transformer block。

[02MOE-history-13](assets/2-MoE-history.assets/02MOE-history-13.png)
...
[02MOE-history-14](assets/2-MoE-history.assets/02MOE-history-14.png)

从上图可以看出，尽管存在负载均衡机制，**自然任务分布**导致不可避免的不均衡。但最忙碌 Expert 仍可获得比最闲 Expert 多 40%~60% Tokens。

[02MOE-history-15-1](assets/2-MoE-history.assets/02MOE-history-15-1.png)
...
[02MOE-history-16](assets/2-MoE-history.assets/02MOE-history-16.png)
