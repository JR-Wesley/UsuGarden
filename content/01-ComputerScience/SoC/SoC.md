...
> 片上系统（SoC）与 RISC-V 生态：总线协议（AMBA/NoC）、缓存、RISC-V 核（玄铁/ysyx/chipyard）、嵌入式与 PCIe，覆盖从体系结构到流片的实践路径。
...
- [[01-ComputerScience/SoC/AMBA|AMBA]]：总线协议标准
- [[01-ComputerScience/SoC/NoC|NoC]]：片上网络
- [[01-ComputerScience/SoC/note-体系结构与-SoC-设计-玄铁|note-体系结构与SoC设计-玄铁]]：玄铁核体系结构笔记

> 说明：`deep-in-riscv-debug-master` 为调试文档源码镜像目录，不单独展开。
