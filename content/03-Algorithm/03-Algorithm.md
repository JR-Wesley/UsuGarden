...
> 算法理论与应用领域：从基础算法、数据压缩、计算机图形学到加密与超维计算（HDC）等专题。兼顾经典教材与前沿研究笔记。

## 主题地图

| 子主题 | 内容概述 | 进度 |
| --- | --- | --- |
| [[03-Algorithm/basic-algorithm/basic-algorithm|basic-algorithm]] | 基础算法：算法（第 4 版）笔记、算法入门、最大公约数等 | 进行中 |
